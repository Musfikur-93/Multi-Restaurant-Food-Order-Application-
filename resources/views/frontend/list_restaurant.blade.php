       ...
       <div class="row">
          <div class="col-md-3">
             <div class="filters shadow-sm rounded bg-white mb-4">
                ...
                @php
                    $categories = App\Models\Category::orderBy('id','desc')->latest()->limit(10)->get();
                @endphp
                      ...
                      <div class="filters-card border-bottom p-4">
                         ...
                         <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                            <div class="filters-card-body card-shop-filters">
                                ...
                                @php
                                    $categoryProductCount = App\Models\Product::where('category_id', $category->id)->count();
                                @endphp
                ...
                @php
                    $cities = App\Models\City::orderBy('id','desc')->latest()->limit(10)->get();
                @endphp
                      ...
                      <div class="filters-card border-bottom p-4">
                         ...
                         <div id="collapseOnecity" class="collapse show" aria-labelledby="headingOnecity" data-parent="#accordion">
                            <div class="filters-card-body card-shop-filters">
                                ...
                                @php
                                    $cityProductCount = App\Models\Product::where('city_id', $city->id)->count();
                                @endphp
                ...
                @php
                    $Menus = App\Models\Menu::orderBy('id','desc')->latest()->limit(10)->get();
                @endphp
                      ...
                      <div class="filters-card border-bottom p-4">
                         ...
                         <div id="collapseOnemenu" class="collapse show" aria-labelledby="headingOnemenu" data-parent="#accordion">
                            <div class="filters-card-body card-shop-filters">
                                ...
                                @php
                                    $menuProductCount = App\Models\Product::where('menu_id', $menu->id)->count();
                                @endphp
