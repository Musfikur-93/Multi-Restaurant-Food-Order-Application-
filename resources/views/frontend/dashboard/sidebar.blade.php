    ...
    <div class="osahan-account-page-left shadow-sm rounded bg-white h-100">
       ...
       <ul class="nav nav-tabs flex-column border-0 pt-4 pl-4 pb-4" id="myTab" role="tablist">
         ...
         <li class="nav-item">
          ...
          <li class="nav-item">
             <a class="nav-link {{ Route::currentRouteName() === 'all.wishlist' ? 'active' : '' }}" href="{{ route('all.wishlist') }}" role="tab" aria-controls="favourites" aria-selected="true"><i class="icofont-heart"></i> Favourites</a>
          </li>
