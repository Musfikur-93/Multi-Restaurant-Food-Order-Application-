             ...
             <div class="offer-dedicated-body-left">
                <div class="tab-content" id="pills-tabContent">
                   <div class="tab-pane fade show active" id="pills-order-online" role="tabpanel" aria-labelledby="pills-order-online-tab">
                        ...
                        @php
                            $populars = App\Models\Product::where('status',1)->where('client_id',$client->id)->where('most_popular',1)->orderBy('id','DESC')->get();
                        @endphp
                         ...
                         <div class="owl-carousel owl-theme owl-carousel-five offers-interested-carousel mb-3">
                            ...
                            <div class="item">
                               <div class="mall-category-item">
                                  <a href="#">
                                     <img class="img-fluid" src="{{ asset($popular->image) }}">
                                     <h6>{{ $popular->name }}</h6>
                                     @if ($popular->discount_price == NULL)
                                         ${{ $popular->price }}
                                     @else
                   ...
                   <div class="tab-pane fade" id="pills-restaurant-info" role="tabpanel" aria-labelledby="pills-restaurant-info-tab">
                      <div id="restaurant-info" class="bg-white rounded shadow-sm p-4 mb-4">
                         ...
                         <p class="mb-2 text-black"><i class="icofont-clock-time text-primary mr-2"></i> {{ $client->info }}
                            {{-- <span class="badge badge-success"> OPEN NOW </span> --}}
                         </p>
                         <hr class="clearfix">
                         <p class="text-black mb-0">Location: <a class="text-info font-weight-bold">{{ $client->city->city_name }}</a></p>
                         <hr class="clearfix">
                         <h5 class="mt-4 mb-2">More Info</h5>
                         <p class="mb-3">{{ $menuNamesString }}</p>
                         <div class="border-btn-main mb-4">
                            <a class="border-btn text-success mr-2"><i class="icofont-check-circled"></i> Breakfast</a>
                            <a class="border-btn text-danger mr-2"><i class="icofont-close-circled"></i> No Alcohol Available</a>
                            <a class="border-btn text-success mr-2"><i class="icofont-check-circled"></i> Separate Smoking Zone</a>
                            <a class="border-btn text-success mr-2"><i class="icofont-check-circled"></i> Indoor Seating</a>
                            <a class="border-btn text-success mr-2"><i class="icofont-check-circled"></i> Launch</a>
                            <a class="border-btn text-danger mr-2"><i class="icofont-close-circled"></i> No Political Conversation</a>
                            <a class="border-btn text-success mr-2"><i class="icofont-check-circled"></i> Dinner</a>
                            <a class="border-btn text-success mr-2"><i class="icofont-check-circled"></i> Children Play Zone</a>
                            <a class="border-btn text-success mr-2"><i class="icofont-check-circled"></i> More Facilities</a>
                         </div>
                      </div>
                   </div>
                   ...
                   <div class="tab-pane fade" id="pills-reviews" role="tabpanel" aria-labelledby="pills-reviews-tab">
                      ...
                      <div class="bg-white rounded shadow-sm p-4 mb-4 restaurant-detailed-ratings-and-reviews">
                         ...
                         @php
                             $reviews = App\Models\Review::where('client_id',$client->id)->where('status',1)->limit(5)->latest()->get();
                         @endphp
                      ...
                      <style>
                        ...
                        .star-rating input[type="radio"]:checked + .star-icon{
                         ...
                         <div class="mb-4">
                            ...
                            <label for="rating-1">
                                <input type="radio" name="rating" id="rating-1" value="1" hidden><i class="icofont-ui-rating icofont-2x star-icon"></i>
                            </label>

                            <label for="rating-2">
                                <input type="radio" name="rating" id="rating-2" value="2" hidden><i class="icofont-ui-rating icofont-2x star-icon"></i>
                            </label>

                            <label for="rating-3">
                                <input type="radio" name="rating" id="rating-3" value="3" hidden><i class="icofont-ui-rating icofont-2x star-icon"></i>
                            </label>

                            <label for="rating-4">
                                <input type="radio" name="rating" id="rating-4" value="4" hidden><i class="icofont-ui-rating icofont-2x star-icon"></i>
                            </label>

                            <label for="rating-5">
                                <input type="radio" name="rating" id="rating-5" value="5" hidden><i class="icofont-ui-rating icofont-2x star-icon"></i>
                            </label>
