            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form id="myForm" action="{{ route('admin.update.product') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="example-text-input" class="form-label">Restraurant Name</label>
                                        <select name="client_id" class="form-select">
                                            @foreach ($client as $cnt)
                                            <option value="{{ $cnt->id }}" {{ $cnt->id == $product->client_id ? 'selected' : '' }}>{{ $cnt->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" name="best_seller" id="formCheck2" value="1" {{ $product->best_seller == 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" name="most_popular" id="formCheck2" value="1" {{ $product->most_popular == 1 ? 'checked' : '' }}>
                                <label class="form-check-label" for="formCheck2">
                                    Most Popular
                                </label>
                            </div>
