                ...
                <div class="card">
                    <div class="card-body">
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                            ...
                            <tr>
                                <td>{{ $key+1 }}</td>
                                <td><img src="{{ asset($item->image) }}" alt="" style="width: 70px; height: 50px;"></td>
                                <td>{{ $item->url }}</td>
                                <td>
            ...
            <form id="myForm" action="{{ route('update.banner') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div>
                            <div class="form-group mb-3">
                                <img id="bannerImage" src="" alt="" class="img-fluid rounded-circle d-block" width="100">
                            </div>
                        </div>
                    </div>
