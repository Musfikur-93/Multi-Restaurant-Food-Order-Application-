...
<div class="page-content">
    <div class="container-fluid">
        ...
        @if ($status === '1')
            <h4>Restraurant Account is <span class="text-success">Active</span></h4>
        @else
            <h4>Restraurant Account is <span class="text-danger">Inactive</span></h4>
            <p class="text-danger">Please be Patience admin will check and then approve.</p>
        @endif
