                        ...
                        <tr>
                            ...
                            <td>
                                @if ($item->discount_price == NULL)
                                    <p class="text-danger">No Discount</p>
                                @else
                                ...
                                @endphp
                                    <p class="text-danger">{{ round($discount) }}%</p>
                                @endif

                            </td>
                            <td>
                                @if ($item->status == 1)
                                    <span class="badge rounded-pill text-bg-success"><b>Active</b></span>
                                @else
                                    <span class="badge rounded-pill text-bg-danger"><b>Inactive</b></span>
                                @endif
                            </td>
                            <td>
