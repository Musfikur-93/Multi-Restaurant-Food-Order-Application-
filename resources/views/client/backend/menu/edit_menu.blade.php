    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-8">
                ...
                <form id="myForm" action="{{ route('update.menu') }}" method="post" enctype="multipart/form-data">
                    @csrf

                    <input type="hidden" name="id" value="{{ $menu->id }}">
                    <input type="hidden" name="old_img" value="{{ $menu->image }}">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mt-3 mt-lg-0">
                                ...
                                <div class="mb-3">
                                    <img id="showImage" src="{{ asset($menu->image) }}" alt="" class="img-fluid rounded-circle d-block" width="100">
                                </div>
