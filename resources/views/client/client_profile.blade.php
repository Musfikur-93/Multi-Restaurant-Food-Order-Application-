                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div>
                                ...
                                <div class="mb-3">
                                    <label for="example-text-input" class="form-label">Restraurant Info</label>
                                    <textarea class="form-control" name="info" row="3" id="example-text-input">{!! $profileData->info !!}</textarea>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mt-3 mt-lg-0">
                                ...
                                <div class="mb-3">
                                    <img id="showImage" src="{{ (!empty($profileData->photo)) ? url('upload/client_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="" class="img-fluid rounded-circle d-block" width="100">
                                </div>
                                ...
                                <div class="mb-3">
                                    <img id="showImage" src="{{ (!empty($profileData->cover_photo)) ? url('upload/client_images/'.$profileData->cover_photo) : url('upload/no_image.jpg') }}" alt="" class="img-fluid d-block" width="200" height="100">
                                </div>
