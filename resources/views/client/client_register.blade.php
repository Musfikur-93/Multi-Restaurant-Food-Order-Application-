                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mt-2">Get your free Client account now.</p>
                                        </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Let's Explore your account ? <a href="{{ route('client.login') }}"
                                                class="text-primary fw-semibold"> Sing In Here </a> </p>
                                        </div>
                                    </div>
